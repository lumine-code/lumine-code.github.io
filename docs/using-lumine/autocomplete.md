...
Community packages can add more providers (for a language server, a framework, a data source, and so on); install them like any other package. See [The package system](../packages-and-themes/package-system.md).
