...
The generator uses the canonical JSDoc extractor from the selected editor checkout, then rewrites
`api/index.html` and `api/api.json`. `LUMINE_CORE_ROOT` may be set instead of passing `--editor`.
